    ...
    // Выводим на экран подсказку для игрока
        ...
        if(rightColors) {
            for(let k=0; k<rightColors; k++){
                prompt_num.insertAdjacentHTML('afterbegin',`<img src='img/smal_white.png' alt='right color'>`);
            }
        }

        if(rightPlace) {
            for(let k=0; k<rightPlace; k++){
                prompt_num.insertAdjacentHTML('afterbegin',`<img src='img/smal_braun.png' alt='right color and place'>`);
            }
        }
